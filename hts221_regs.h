...
/* WHO_AM_I Register Fields */
    /* WHO_AM_I -> WHO_AM_I */
    #define HTS_WHO_AM_I_WHO_AM_I_FIELD_MASK                       0xFF /* Id Register */
    #define HTS_WHO_AM_I_WHO_AM_I_FIELD_OFFSET                     0x00
...
/* CTRL3 Register Fields */
    /* CTRL3 -> CTRL3 */
    #define HTS_CTRL3_CTRL3_FIELD_MASK                             0xFF /* Control register 3 */
    #define HTS_CTRL3_CTRL3_FIELD_OFFSET                           0x00
 ...
 * @param dev ptr to HTS221 device
 */
#define hts_get_who_am_i(dev) regdev_read_field(&(dev)->mRegDev, &(dev)->mWhoAmI, HTS_WHO_AM_I_WHO_AM_I_FIELD_MASK )
/**
 ...
 * @param dev ptr to HTS221 device
 */
#define hts_get_ctrl3(dev) regdev_read_field(&(dev)->mRegDev, &(dev)->mCtrl3, HTS_CTRL3_CTRL3_FIELD_MASK )
/**
 ...
 * @param dev ptr to HTS221 device
 */
#define hts_set_ctrl3(dev, val) regdev_write_field(&(dev)->mRegDev, &(dev)->mCtrl3, HTS_CTRL3_CTRL3_FIELD_MASK , (val) )
